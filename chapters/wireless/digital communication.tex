...
\begin{section}{Signal Transmission and Reception}
  ...
  \begin{subsection}{Digital Modulations}
    ...
    \begin{subsection}{M-QAM}
      \begin{boxH}
        With M-QAM we refer to a modulation that uses $M$ symbols, and is represented over two
        orthonormal basis.
      \end{boxH}
      This means that we can represent $\sqrt{M}$ symbols over each axis, and the total number of
      symbols is $M$.\\
